          ...
          <div class="ps-3">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">List of Daiy Collection</li>
              </ol>
            </nav>
          </div>
            ...
            <div class="row row-cols-1 row-cols-xl-2 row-cols-xxl-3">
                ...
                <div class="col">
                    ...
                    <div class="card-body">
                        ...
                        <div class="info">
                            <h6 class="mb-2">Diposites Summary</h6>
                          ...
                          <p class="mb-1"><strong>Created Date </strong> : {{ $customFormatDate}}</p>
                            <p class="mb-1"><strong>Maturity Amount {{ env('DB_RUPEE') }}</strong> :{{ $customer->pa }}</p>
                            <p class="mb-1"><strong>Total Amount {{ env('DB_RUPEE') }}</strong> :{{ $totalEmis->total_emi_paid }}</p>
                            <p class="mb-1"><strong>Total Invested till date {{ env('DB_RUPEE') }}</strong> :{{ $customer->pi }}</p>

                            <p class="mb-1"><strong>Interest {{ env('DB_RUPEE') }}</strong> :{{ $customer->ti }}</p>
                            <p class="mb-1"><strong>Total fines {{ env('DB_RUPEE') }}</strong> :{{ $totalEmis->total_fines }}</p>
                        </div>
                        </div>
                    </div>
                    </div>
                                ...
                                <td>
                                    ...
                                    <div class="row">
                                        <div class="col-4" >
                                            ...
                                            <form method="POST" id="divHide" action="{{ route('update_rd_emi',Crypt::encryptString($item->id)) }}">
                                                @csrf
                                                @method('PUT')
